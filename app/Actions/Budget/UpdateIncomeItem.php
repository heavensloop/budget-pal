...
class UpdateIncomeItem
{
    /**
     * @param  array<string, mixed>  $data  validated UpdateIncomeItemRequest input
     */
    public function __invoke(IncomeItem $item, array $data): IncomeItem
    {
